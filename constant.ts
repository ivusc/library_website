...
export const CategoryItems : Array<ICatItem> = [
  ...
  {image: categoryIcons['adventure'], title: 'Adventure', link: '/category/adventure'},
  ...
  {image: categoryIcons['fantasy'], title: 'Fantasy', link: '/category/fantasy'},
  {image: categoryIcons['fiction'], title: 'Fiction', link: '/category/fiction'},
  {image: categoryIcons['horror'], title: 'Horror', link: '/category/horror'},
  {image: categoryIcons['magic'], title: 'Magic', link: '/category/magic'},
  {image: categoryIcons['mystery'], title: 'Mystery', link: '/category/mystery_and_detective_stories'},
  {image: categoryIcons['nonFiction'], title: 'Non Fiction', link: '/category/non_fiction'},
  {image: categoryIcons['romance'], title: 'Romance', link: '/category/romance'},
  {image: categoryIcons['science fiction'], title: 'Science Fiction', link: '/category/science_fiction'},
